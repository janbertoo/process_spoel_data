...
lowess = sm.nonparametric.lowess(total_velocity_df['velocity_log'], total_velocity_df['length_median'], frac=0.3)

# Plotting
plt.figure(figsize=(6, 4))
plt.scatter(total_velocity_df['length_median'], total_velocity_df['velocity_log'], alpha=0.6, label='Data')
...
plt.legend()
plt.tight_layout()
plt.savefig('step10_analyze_rotation/analyze_velocity_log_with_length_spearman_trend.pdf')
plt.show()
