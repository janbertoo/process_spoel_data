...
plt.legend()
plt.tight_layout()
plt.savefig('step10_analyze_rotation/analyze_velocity_log_with_length_with_trendline.pdf')
plt.savefig('step10_analyze_rotation/analyze_velocity_log_with_length_with_trendline.png')
plt.show()
