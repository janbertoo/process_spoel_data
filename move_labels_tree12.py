...
#for tree12
folders = [
	'/home/jean-pierre/ownCloud/phd/code_code_code_code_code/process_spoel_data/cut_data/DCIM-drone6/drone6vid1',
	'/home/jean-pierre/ownCloud/phd/code_code_code_code_code/process_spoel_data/cut_data/DCIM-drone6/drone6vid2',
	'/home/jean-pierre/ownCloud/phd/code_code_code_code_code/process_spoel_data/cut_data/DCIM-drone6/drone6vid3',
	'/home/jean-pierre/ownCloud/phd/code_code_code_code_code/process_spoel_data/cut_data/DCIM-drone6/drone6vid4',
	'/home/jean-pierre/ownCloud/phd/code_code_code_code_code/process_spoel_data/cut_data/DCIM-drone6/drone6vid5',
]
		...
		if file[-4:] == '.txt':
			...
			for i in range(2):
				...
				if rw_location != None:
					...
					#print(xcoor)
					#print(ycoor)
					#print(xcoor+' '+ycoor+', '+rw_location[0]+' '+rw_location[1]+' '+rw_location[2]+'\n')
					if i == 0:
						f_labels_with_gcps.write('\n')
