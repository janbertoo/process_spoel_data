...
curdir = os.getcwd()
#print(curdir)
csvdata = os.path.join(curdir,'GPS_Data-20230619T123957Z-001/GPS_Data/drone16_spoelgcps_notest_adjusted12_no_special.csv')
#print(csvdata)
csvdataforprocessing = os.path.join(curdir,'GPS_Data-20230619T123957Z-001/GPS_Data/drone16_spoelgcps_notest_no_special.csv')
    ...
    for basepath in pathsdrone:
        ...
        for file in os.listdir(path):
            ...
            if os.path.exists(outputtxtpath) == False or os.path.exists(outputtxtpath) == True:
                ...
                with open(outputtxtpath, 'a') as outfile:
