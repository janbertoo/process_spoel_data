...
# Saving the figures
plt.savefig(os.path.join(savefigfolder,'pareto_graph_piece_volumes.eps'))
plt.savefig(os.path.join(savefigfolder,'pareto_graph_piece_volumes.png'))
plt.savefig(os.path.join(savefigfolder,'pareto_graph_piece_volumes.pdf'))
