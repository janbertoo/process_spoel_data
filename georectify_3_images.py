...
output_image_path = '/media/jean-pierre/PortableSSD/georec_3ims.jpg'
...
'''
plt.arrow(200,25,0,5,width=1.5,color='black')
plt.text(200, 38, 'N', fontsize = 170, color='black', ha='center')
...
for i in range(num_segments):
    ...
    ax.fill([x, x + segment_width, x + segment_width, x], [y, y, y + width, y + width], color=color, edgecolor='black', linewidth=1.5, transform=ax.transData)
    ...
    ax.text(x, y - 3, f'{segment_length_meters_seg}', ha='center', va='center', fontsize=80)

    if i == num_segments-1:
        segment_length_meters_seg = int(segment_length_meters * (i+1))
        ax.text(x + segment_width, y - 3, f'{segment_length_meters_seg}', ha='center', va='center', fontsize=80)


ax.text(start_of_scale + (num_segments*segment_width)/2, 31+width/2, 'Meters', ha='center', va='center', fontsize=80)
...
plt.arrow(178,42,-10,-1.5,width=1.5,color='black')
plt.text(174.5, 44, 'Flow Direction', fontsize = 100, color='black', ha='center')
