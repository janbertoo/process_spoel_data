...
file1 = pd.read_csv(file2, header=None, names=['X', 'Y', 'Vx', 'Vy'])
file2 = pd.read_csv(file3, header=None, names=['X', 'Y', 'Vx', 'Vy'])
...
merged_df.to_csv('subtracted_data_23.csv', index=False)
