...
for i in range(len(stagered_drone_ims)):
    ...
    if hom_drone1_flag != False:
        file_1 = open(name_georeferenced_image.replace('.jpg','_hom_drone1.p'), 'wb')
        pickle.dump(hom_drone1,file_1)

    
    if hom_drone2_flag != False:
        file_2 = open(name_georeferenced_image.replace('.jpg','_hom_drone2.p'), 'wb')
        pickle.dump(hom_drone2,file_2)

    
    if hom_drone3_flag != False:
        file_3 = open(name_georeferenced_image.replace('.jpg','_hom_drone3.p'), 'wb')
