...
for section, section_number, water_level_base, pre_section_file, post_section_file in sections_and_water_levels:
    ...
    #plt.show()
    plt.savefig(savefigfolder+'section_'+str(section_number)+'_wood_distribution_per_video_large.eps')
    plt.savefig(savefigfolder+'section_'+str(section_number)+'_wood_distribution_per_video_large'+str(weighted_average)+'.png')
    plt.savefig(savefigfolder+'section_'+str(section_number)+'_wood_distribution_per_video_large.pdf')
