...
plt.ylim(total_velocity_df['velocity_log'].min() - 1, total_velocity_df['velocity_log'].max() + 1)
plt.legend()
plt.tight_layout()

# Save the plot
plt.savefig('step10_analyze_rotation/log_angle_vs_log_speed_trendline.png')
plt.savefig('step10_analyze_rotation/log_angle_vs_log_speed_trendline.pdf')
