...
kde = sns.kdeplot(
    x=total_rotation_df['closest_gradient'],
    y=total_rotation_df['abs_rotation'],
    fill=True,
    cmap="Blues",
    thresh=0,
    cbar=True  # <--- This adds the colorbar!
)
...
# Calculate the percentage of points with rotation lower than 4 degrees
rotation_below_4 = total_rotation_df[total_rotation_df['abs_rotation'] < 4]
percentage_rotation_below_4 = (len(rotation_below_4) / len(total_rotation_df)) * 100

print(f"Percentage of datapoints with rotation below 4 degrees per 0.25 s: {percentage_rotation_below_4:.2f}%")
