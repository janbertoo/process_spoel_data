...
for section, section_number, water_level_base, pre_section_file, post_section_file in sections_and_water_levels:
    ...
    #plt.show()
    plt.savefig(savefigfolder+'section_'+str(section_number)+'_wood_distribution_per_video_small.eps')
    plt.savefig(savefigfolder+'section_'+str(section_number)+'_wood_distribution_per_video_small'+str(weighted_average)+'.png')
    plt.savefig(savefigfolder+'section_'+str(section_number)+'_wood_distribution_per_video_small.pdf')
