...
plt.legend()
plt.tight_layout()
plt.savefig('step10_analyze_rotation/analyze_log_velo_with_log_angle_with_trendline.pdf')
plt.savefig('step10_analyze_rotation/analyze_log_velo_with_log_angle_with_trendline.png')
plt.show()
