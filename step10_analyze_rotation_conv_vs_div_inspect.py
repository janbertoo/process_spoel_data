...
def calculate_rotation(top_left1, bottom_right1, top_left2, bottom_right2):
    ...
    if 270 > rotation > 90:
        ...
        plt.scatter(*top_left1, color='green', label='Top Left 1', s=100)
        plt.scatter(*bottom_right1, color='green', label='Bottom Right 1', s=100)
        plt.scatter(*top_left2, color='red', label='Top Left 2', s=100)
        plt.scatter(*bottom_right2, color='red', label='Bottom Right 2', s=100)
