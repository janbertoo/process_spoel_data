...
plt.xlabel('Wood Piece Angle (degrees)')
plt.ylabel('Density')
plt.grid(True)
plt.legend(title="Area Flow Pattern")
plt.tight_layout()  # Automatically adjusts subplot parameters to give some padding
plt.savefig('step10_analyze_rotation/log_angle_distribution_kde_diverging_converging_only_large.png')
plt.savefig('step10_analyze_rotation/log_angle_distribution_kde_diverging_converging_only_large.pdf')
plt.show()
