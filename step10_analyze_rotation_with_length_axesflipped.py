...
#plt.title('Scatter plot of Length vs Rotation')
plt.xlabel('Length (m)')
plt.ylabel('Rotation (° / 0.25 s)')
plt.legend()
plt.tight_layout()
plt.savefig('step10_analyze_rotation/analyze_length_vs_rotation_with_trendline.png')
plt.savefig('step10_analyze_rotation/analyze_length_vs_rotation_with_trendline.pdf')
