...
plt.title('Length vs Normalised Velocity')
plt.xlabel('Length (m)')
plt.ylabel('Normalised Velocity (m/s)')
plt.ylim(-3.5, 5)
plt.legend()
plt.tight_layout()
plt.savefig('step10_analyze_rotation/analyze_normalized_velo_with_length_with_trendline_only_large.pdf')
plt.savefig('step10_analyze_rotation/analyze_normalized_velo_with_length_with_trendline_only_large.png')
plt.show()
