...
plt.title('Ratio Length Diameter vs Normalised Velocity')
plt.xlabel('Length / Diameter')
plt.ylabel('Normalised Velocity (m/s)')
plt.ylim(-3.5, 5)
plt.legend()
plt.tight_layout()
plt.savefig('step10_analyze_rotation/analyze_log_velo_with_ratio_length_diam_with_trendline_v2.pdf')
plt.savefig('step10_analyze_rotation/analyze_log_velo_with_ratio_length_diam_with_trendline_v2.png')
plt.show()
