...
var2 = total_rotation_df['length_median']
...
# Titles and labels
plt.title('Scatter plot of Rotation vs Length')
...
# Save and show plot
plt.savefig('step10_analyze_rotation/analyze_rotation_vs_length_with_trendline.pdf')
plt.savefig('step10_analyze_rotation/analyze_rotation_vs_length_with_trendline.png')
#plt.show()
