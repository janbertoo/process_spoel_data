...
total_rotation_df = total_rotation_df.dropna(subset=['volume_median', 'abs_rotation'])
...
for i, q in enumerate(quantiles):
    quantile_model = smf.quantreg("abs_rotation ~ volume_median", total_rotation_df).fit(q=q)
...
plt.legend()
#lt.title('Quantile Regression of Rotation vs. Log Volume')
plt.tight_layout()
plt.savefig('step10_analyze_rotation/analyze_volume_vs_rotation_with_multiple_quantiles.png')
plt.savefig('step10_analyze_rotation/analyze_volume_vs_rotation_with_multiple_quantiles.pdf')
