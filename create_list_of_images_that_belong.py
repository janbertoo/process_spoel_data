...
outputdirpath = '/home/jean-pierre/Desktop/5feb'
...
for vidnumber in [1,2,3,4,5]:
    ...
    for i in range(0,200000):
        ...
        stagered_drone_ims_only.append([drone1im,drone6im,drone16im])

    with open("/home/jean-pierre/Desktop/8feb/vid"+str(vidnumber)+".txt", "w") as file:
        for data in stagered_drone_ims_only:
            try:
                file1 = data[0].split('/')[-1]
            except:
                file1 = 'None'
            try:
                file2 = data[1].split('/')[-1]
            except:
                file2 = 'None'
            try:
                file3 = data[2].split('/')[-1]
            except:
                file3 = 'None'
            file.write(file1+' '+file2+' '+file3+'\n')
