...
total_velocity_df = total_velocity_df.dropna(subset=['normalized_velocity', 'log_angle', 'length_median', 'diameter_median'])
...
X = total_velocity_df[['diameter_median','length_median','log_angle']]
#X = total_velocity_df[['velocity_log']]
y = total_velocity_df['normalized_velocity']
#y = total_velocity_df['velocity_log']

# Multiple linear regression model
#X = total_velocity_df[['diameter_median']]
#X = total_velocity_df[['velocity_log']]
#y = total_velocity_df['velocity_log']
#y = total_velocity_df['velocity_log']
