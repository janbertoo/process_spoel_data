...
outputdir = '/home/jean-pierre/Desktop/12feb/surface_vids'
...
def georectify(data):
    try:
        ...
        plt.ylim(1175245-Ybase, 1175295-Ybase)
        plt.xlim(2804085-Xbase, 2804190-Xbase)
        plt.tight_layout()
    ...
    for vidnumber in [2,3,4,5]:
        ...
        for file in os.listdir(homsdirpath):
            if file[-2:] == '.p':
                ...
                #    continue
                #else:
                before_and_after = find_closest_correct_hom_paths(os.path.join(homsdirpath,file))
