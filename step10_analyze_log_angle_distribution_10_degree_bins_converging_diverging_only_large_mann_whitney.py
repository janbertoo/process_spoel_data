...
sns.boxplot(data=total_velocity_df, x='area_pattern', y='log_angle')
plt.xlabel('Area Type')
plt.ylabel('Log Angle (degrees)')
plt.title('Boxplot of Log Angles in Diverging and Converging Areas')
plt.grid(True)
plt.tight_layout()
plt.savefig('step10_analyze_rotation/log_angle_boxplot.png')
plt.savefig('step10_analyze_rotation/log_angle_boxplot.pdf')
plt.show()
