...
var2 = total_rotation_df['diameter_median']
...
# Titles and labels
plt.title('Scatter plot of Rotation vs Diameter')
...
# Save and show plot
plt.savefig('step10_analyze_rotation/analyze_rotation_vs_diameter_with_trendline.pdf')
plt.savefig('step10_analyze_rotation/analyze_rotation_vs_diameter_with_trendline.png')
#plt.show()
