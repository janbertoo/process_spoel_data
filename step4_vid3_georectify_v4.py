...
for i in range(len(stagered_drone_ims)):
    ...
    try:
        ...
        if name_original_image2 == None:
            ...
            virtuals_coors_txt2_alternative = create_two_virtual_gcps(coors_4ctxt2_alternative)
        ...
        if name_original_image == None:
            ...
            virtuals_coors_txt1_alternative = create_two_virtual_gcps(coors_4ctxt1_alternative)
    ...
    if hom_drone1_flag != False:
        ...
        file_1 = open(name_georeferenced_image.replace('.jpg',txt1_name+'_hom.p'), 'wb')
        pickle.dump(hom_drone1,file_1)

    
    if hom_drone2_flag != False:
        txt2_name = (txt2.split('/')[-1]).split('.txt')[0]
        file_2 = open(name_georeferenced_image.replace('.jpg',txt2_name+'_hom.p'), 'wb')
        pickle.dump(hom_drone2,file_2)

    
    if hom_drone3_flag != False:
        txt3_name = (txt3.split('/')[-1]).split('.txt')[0]
        file_3 = open(name_georeferenced_image.replace('.jpg',txt3_name+'_hom.p'), 'wb')
