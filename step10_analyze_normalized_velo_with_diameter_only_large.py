...
plt.title('Diameter vs Normalised Velocity')
plt.xlabel('Diameter (m)')
plt.ylabel('Normalised Velocity (m/s)')
plt.ylim(-3.5, 5)
plt.legend()
plt.tight_layout()
plt.savefig('step10_analyze_rotation/analyze_normalized_velo_with_diameter_with_trendline_only_large.pdf')
plt.savefig('step10_analyze_rotation/analyze_normalized_velo_with_diameter_with_trendline_only_large.png')
plt.show()
