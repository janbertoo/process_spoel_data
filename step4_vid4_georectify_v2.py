...
outputdir = os.path.join('/home/jean-pierre/Desktop/28nov','vid'+str(vidnumber))
fps = 24
freq = 4
freq_old = 2
...
drone1frame_drone6frame_drone16frame = [1826,1850,1821]
drone1frame_drone6frame_drone16frame = [26,0,22]
...
for i in range(len(stagered_drone_ims)):
    ...
    try:
        ...
        if name_original_image2 == None:
            ...
            virtuals_coors_txt2 = create_two_virtual_gcps(coors_4ctxt2)
            ...
            try:
                ...
                #drone6
                hom = find_homography(UV02, XYZ02, camera_matrix_drone6, distortion_coefficients_drone6)
            except:
        ...
        if name_original_image == None:
            ...
            virtuals_coors_txt1 = create_two_virtual_gcps(coors_4ctxt1)
            ...
            try:
                ...
                #drone1
                hom = find_homography(UV0, XYZ0, camera_matrix_drone1, distortion_coefficients_drone1)
            except:
                xyzs = []
                for i in range(len(coorstxt1)):
                    xyzs.append(coorstxt1[i][1])
    ...
    if name_original_image3 == None:
        ...
        try:
            ...
            #drone16
            hom = find_homography(UV03, XYZ03, camera_matrix_drone16, distortion_coefficients_drone16)
        except:
            xyzs = []
            for i in range(len(coorstxt3)):
                xyzs.append(coorstxt3[i][1])
    ...
    @print('saving '+name_georeferenced_image.replace('.jpg','_divby_'+str(divby)+'.jpg'))
