...
plt.legend()
plt.tight_layout()
plt.savefig('step10_analyze_rotation/analyze_normalized_velo_with_rotation_with_trendline.pdf')
plt.savefig('step10_analyze_rotation/analyze_normalized_velo_with_rotation_with_trendline.png')
plt.show()
