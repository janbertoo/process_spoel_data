...
# Step 1: Histogram to check bimodal distribution
...
# Step 2: KDE plot to confirm bimodal nature
plt.figure(figsize=(6, 4))
...
num_clusters = 2  # Assuming bimodal distribution

gmm = GaussianMixture(n_components=num_clusters, random_state=42)
total_velocity_df['cluster'] = gmm.fit_predict(total_velocity_df[['flow_speed']])

# Step 4: Compare statistics of two clusters
...
plt.legend()
plt.title('Clustered Log Angle vs. Flow Velocity')
plt.show()
