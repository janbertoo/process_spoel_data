...
def create_a_virtual_gcp_from_2_gcps(GCP1_uv_coors,GCP2_uv_coors,GCP1_rw_coors,GCP2_rw_coors):
    virGCP_uv = ( (GCP1_uv_coors[0]-GCP2_uv_coors[0]) / 2 , (GCP1_uv_coors[1]-GCP2_uv_coors[1]) / 2)
    
    virGCP_rw = ( (GCP1_rw_coors[0]-GCP2_rw_coors[0]) / 2 , (GCP1_rw_coors[1]-GCP2_rw_coors[1]) / 2 , (GCP1_rw_coors[2]-GCP2_rw_coors[2]) / 2 )
...
for dronenumber in [16]:
    for vidnumber in [3]:
        ...
        for entry in all_info:
            ...
            diff_and_homs.append([totaldiff,(homography)])
            ...
            for i in range(len(coorstxt)):
                ...
                try:
                    ...
                    diff_and_homs.append([op_totaldiff,(op_homography)])
