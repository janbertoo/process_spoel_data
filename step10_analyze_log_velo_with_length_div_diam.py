...
# Filter out rows with NaN values in 'velocity_log' and 'ratio_length_diameter'
...
plt.legend()
plt.tight_layout()
plt.savefig('step10_analyze_rotation/analyze_velocity_log_with_ratio_length_diam_with_trendline.pdf')
plt.savefig('step10_analyze_rotation/analyze_velocity_log_with_ratio_length_diam_with_trendline.png')
plt.show()
