...
def georectify_three_images(data):
    ...
    if framenumber % 8 == 0:
        ...
        if im2 == None:
            ...
            plt.tight_layout()
            #print('hoi1')
            plt.savefig(os.path.join(data[4],data[0][1].split('/')[-1]))
            #print('hoi1_na')
            #print(data[2])
            #print(data[3][1])
            file_1 = open( (os.path.join(data[4],data[0][1].split('/')[-1])).replace('.jpg','_hom.p'),'wb')
            #print(file_1)
            pickle.dump(drone2_homography,file_1)
        ...
        if im1 == None:
            ...
            plt.tight_layout()
            #print('hoi2')
            plt.savefig(os.path.join(data[4],data[0][0].split('/')[-1]))

            file_1 = open( (os.path.join(data[4],data[0][0].split('/')[-1])).replace('.jpg','_hom.p') ,'wb')
            print(file_1)
            pickle.dump(drone1_homography,file_1)
