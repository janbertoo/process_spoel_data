...
total_velocity_df['acceleration'] = total_velocity_df.groupby('ID')['velocity_log'].diff() / total_velocity_df.groupby('ID')['timestamp'].diff()
...
plt.title('Spatial Distribution of Average Acceleration')
...
plt.savefig('spatial_acceleration_grid.pdf')
plt.savefig('spatial_acceleration_grid.png')
plt.show()
