...
# Plot KDEs of rotation for both classes
...
plt.title('KDE of Rotation for Accelerating and Decelerating Logs')
plt.xlabel('Rotation (°)')
plt.ylabel('Density')
plt.legend()
plt.tight_layout()
...
plt.savefig('kde_rotation_acceleration_classes.pdf')
plt.savefig('kde_rotation_acceleration_classes.png')
plt.show()
