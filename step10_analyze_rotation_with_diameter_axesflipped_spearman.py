...
spearman_corr, spearman_p_value = stats.spearmanr(total_rotation_df['diameter_median'], total_rotation_df['rotation'])
...
lowess = sm.nonparametric.lowess(total_rotation_df['rotation'], total_rotation_df['diameter_median'], frac=0.3)

# Plotting
plt.figure(figsize=(4, 4))
plt.scatter(total_rotation_df['diameter_median'], total_rotation_df['rotation'], alpha=0.6, label='Data')
...
plt.legend()
plt.tight_layout()
plt.savefig('step10_analyze_rotation/analyze_diameter_vs_rotation_spearman_trend.pdf')
plt.show()
