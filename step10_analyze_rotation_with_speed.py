...
# Titles and labels
plt.title('Scatter plot of Rotation vs Velocity')
plt.xlabel('Rotation (° / 0.25 s)')
plt.ylabel('LSPI Velocity (m/s)')
plt.legend()
plt.tight_layout()

# Save and show plot
plt.savefig('step10_analyze_rotation/analyze_rotation_vs_speed_with_trendline.pdf')
plt.savefig('step10_analyze_rotation/analyze_rotation_vs_speed_with_trendline.png')
plt.show()
