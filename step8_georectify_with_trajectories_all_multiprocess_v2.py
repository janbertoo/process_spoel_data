    ...
    if os.path.exists(output_image_path) != True:
        ...
        if detections != None:
            for detection in detections:
                ...
                #    print('IS INT')
                if detection[0] in drone_id_coordinates[detection[1]]:
                    print('OLDOLOLDLDLD')
                    old_coordinates = drone_id_coordinates[detection[1]][detection[0]]
            
                new_coordinates = detection[2]
                ...
                if drone_number in drone_id_coordinates:
                    ...
                    if id_number in drone_id_coordinates[drone_number]:
